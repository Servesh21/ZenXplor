...
const Homepage: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex flex-col overflow-hidden transition duration-300">
      ...
      <header className="relative flex flex-col items-center justify-center text-center h-screen px-6">
        <motion.h1
          ...
          className="text-6xl md:text-7xl font-bold leading-tight text-gray-800 dark:text-gray-100"
        >
          Find Files Instantly
        </motion.h1>

        <motion.p
          className="text-3xl text-gray-700 dark:text-gray-300 mt-4 font-semibold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5, duration: 0.8 }}
        >
          Instantly locate any file from
          <span className="text-blue-600 dark:text-blue-400 font-bold ml-2">{displayedText}</span>
          {cursorVisible && <span className="text-blue-600 dark:text-blue-400">|</span>}
        </motion.p>
        ...
        <motion.p
          ...
          className="text-xl text-gray-600 dark:text-gray-400 mt-6"
        >
        ...
        <Link
          to="/login"
          className="mt-6 px-8 py-3 text-lg font-semibold bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-800 text-white transition duration-300 rounded-full shadow-md"
        >
          Get Started
        </Link>
      </header>

      <section className="w-full py-20 bg-gray-100 dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-gray-200">Key Features</h2>
          <p className="text-center text-gray-600 dark:text-gray-400 mt-2">
            Everything you need for effortless file searching.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-10">
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 dark:shadow-lg rounded-xl shadow-md p-6 flex flex-col items-center text-center w-64 transition duration-300"
              >
